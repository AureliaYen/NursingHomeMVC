...
namespace preNursingHouse.Models
{
    public partial class fpdb2Context : DbContext
    {
        ...
        public virtual DbSet<TActivityCollect> TActivityCollect { get; set; }
        public virtual DbSet<TActivityComment> TActivityComment { get; set; }
        public virtual DbSet<TActivityMessage> TActivityMessage { get; set; }
        public virtual DbSet<TActivityOrder> TActivityOrder { get; set; }
        public virtual DbSet<TApplicationForm> TApplicationForm { get; set; }
        public virtual DbSet<TBed> TBed { get; set; }
        public virtual DbSet<TEmployee> TEmployee { get; set; }
        public virtual DbSet<TFamilyMembers> TFamilyMembers { get; set; }
        public virtual DbSet<TImages> TImages { get; set; }
        public virtual DbSet<TMeal> TMeal { get; set; }
        public virtual DbSet<TMember> TMember { get; set; }
        public virtual DbSet<TNursingRecord> TNursingRecord { get; set; }
        public virtual DbSet<TOffService> TOffService { get; set; }
        public virtual DbSet<TOrder> TOrder { get; set; }
        public virtual DbSet<TOrderMeal> TOrderMeal { get; set; }
        public virtual DbSet<TPatientInfo> TPatientInfo { get; set; }
        public virtual DbSet<TProduct> TProduct { get; set; }
        public virtual DbSet<TRoombed> TRoombed { get; set; }
        public virtual DbSet<TShift> TShift { get; set; }
        public virtual DbSet<TSupplier> TSupplier { get; set; }
        public virtual DbSet<TTake> TTake { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TActivity>(entity =>
            {
                ...
                entity.Property(e => e.Act主講人描述)
                    .IsRequired()
                    .HasColumnName("act主講人描述");
                ...
                entity.Property(e => e.Act活動圖片)
                    .IsRequired()
                    .HasColumnName("act活動圖片");
                ...
                entity.Property(e => e.Act活動說明)
                    .IsRequired()
                    .HasColumnName("act活動說明");
            ...
            modelBuilder.Entity<TFamilyMembers>(entity =>
            {
